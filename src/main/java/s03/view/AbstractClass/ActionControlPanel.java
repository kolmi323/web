...
public abstract class ActionControlPanel<S extends ActionControlService> {
    ...
    public ActionControlPanel(ServiceDTO service, UserDTO selectedUser) {
        ...
        this.service = createActionControlService(service, selectedUser);
        this.userDataReceiver = new UserDataReceiver(service);
        this.controlExit = new ControlExit();
    }

    protected abstract S createActionControlService(ServiceDTO service, UserDTO selectedUser);
